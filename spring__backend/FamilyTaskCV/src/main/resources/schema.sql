...
create table child (id integer not null AUTO_INCREMENT, first_name varchar(55), pesel varchar(11), second_name varchar(55), sex varchar(1), primary key (id))
...
create table father (id integer not null AUTO_INCREMENT, birth_date date, first_name varchar(55), pesel varchar(11), second_name varchar(55), primary key (id))
